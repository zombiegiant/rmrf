    ...
    <div class="twelve columns header_nav">
        <div class="row">
            ...
            <ul id="menu-header" class="nav-bar horizontal">
                ...
                <!-- <li class=""><a href="blog_single.html">Один проект</a></li> -->


                <li class="has-flyout">
                    <a href="#">Проекты</a><a href="#" class="flyout-toggle"></a>
                    <ul class="flyout"><!-- Flyout Menu -->
                        <li class="has-flyout"><a href="requestProject.php">Предложить</a></li>
                        <li class="has-flyout"><a href="viewProjects.php">Смотреть проекты</a></li>
                        <li class="has-flyout active"><a href="execProjects.php">Выполнется</a></li>
                        <li class="has-flyout"><a href="completeProjects.php">Готовые</a></li>
                    </ul>
                </li>
                <li class=""><a href="contact.php">Контактная информация</a></li>
