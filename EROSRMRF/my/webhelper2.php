...
print "<body>";
print $status;
print "<form action='webhelper2.php' method='POST'>
...
{
	print "<div style='position:relative; width:500px; height:200px;'>";
...
<form action='webhelper2.php' id='data' method='POST'>
...
<form action='webhelper2.php' method='POST'>
...
print "<div style='position:relative;bottom:2px;'><textarea form='data'  style='font-family:monospace;' name='zapr' cols='$_SESSION[col]'rows='$_SESSION[row]'>$zapros</textarea>";
